...
import 'package:effectivelearning/board/video.dart';
...
class _CoursePageState extends State<CoursePage> {
  ...
  File file;
  List<VideoPlayerController> controllers = new List();
  List<ChewieController> chewieControllers = new List();

  void checkVideo() {
    // if (controllers.last.value.hasError) {
    ...
    // if (controllers.last.value.position ==
    //     Duration(seconds: 0, minutes: 0, hours: 0)) {
    //   zlog('video Started');
    // }

    // if (controllers.last.value.position == controllers.last.value.duration) {
    //   zlog('video Ended');
  ...
  void deactivate() {
    try {
      ...
      chewieControllers.last.dispose();
      super.deactivate();
    } catch (e) {
  ...
  Future<void> enterFull() async {
    ...
    chewieControllers.last.enterFullScreen();
  }
  ...
  Future<void> initVideoPlayer() async {
    ...
    try {
      chewieControllers.last.removeListener(checkVideo);
      chewieControllers.last.pause();
      chewieControllers.last.dispose();
      controllers.last.dispose();
    } catch (e) {
    ...
    chewieControllers.add(ChewieController(
      videoPlayerController: controllers.last,
      autoPlay: true,
      looping: false,
    ));

    chewieControllers.last.addListener(checkVideo);
  ...
  Widget build(BuildContext context) {
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      Share.share("https://www.effectivelearning.institute/",
    ...
    detailReviews() {
      String strRate5 =
          (ratingCnt == 0 ? 0 : ratingMarks[5] * 100 / ratingCnt).toString();
      String strRate4 =
          (ratingCnt == 0 ? 0 : ratingMarks[4] * 100 / ratingCnt).toString();
      String strRate3 =
          (ratingCnt == 0 ? 0 : ratingMarks[3] * 100 / ratingCnt).toString();
      String strRate2 =
          (ratingCnt == 0 ? 0 : ratingMarks[2] * 100 / ratingCnt).toString();
      String strRate1 =
          (ratingCnt == 0 ? 0 : ratingMarks[1] * 100 / ratingCnt).toString();
      return Container(
          color: colBaseGreyLight,
          width: scrWidth * 0.9,
          alignment: Alignment.centerLeft,
          ...
          child: Column(children: <Widget>[
            Row(children: <Widget>[
              ...
              star(ratingAvg.toDouble(), true, 20.0),
              txt17("  " +
                  ratingAvg.toString() +
                  " (" +
                  ratingCnt.toString() +
    ...
    return Scaffold(
        ...
        body: Stack(children: <Widget>[
          SingleChildScrollView(
            ...
            _videoPlay
                ? Chewie(
                    controller: chewieControllers.last,
                  )
                : CachedNetworkImage(
                              ...
                              : _selTab == 2
                                  ...
                                  Column(
                                      children: <Widget>[
                                        ...
                                        Column(
                                            children: List.generate(qas.length,
                                                (index) {
                                          return Card(
                                              child: SizedBox(
                                                  width: scrWidth * 0.9,
                                                                ...
                                                                children: <
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child: Row(
                                                                        children: <
                                                                          ...
                                                                          CachedNetworkImage(
                                                                              imageUrl: getInstructorImg(qas[index]['replies'][j]['user_id']),
                                                                  ...
                                                                  Row(
                                                                    children: <
                                                                      ...
                                                                      SizedBox(
                                                                        child: txt17(qas[index]['replies'][j]
                                                                            [
                                                                            'body']),
                                                                      )
                                                                    ],
